...
#ifndef ONGAKUDESKTOP_SWIFT_H
#define ONGAKUDESKTOP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OngakuDesktop",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC13OngakuDesktop15WindowProbeView")
@interface WindowProbeView : NSView
